...
public class deleteperson extends JFrame {
	...
	public deleteperson() {
		...
		JLabel lblEnterId = new JLabel("Enter Mobile_no:");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(c==null||c.trim().equals("")){
					JOptionPane.showMessageDialog(deleteperson.this,"Id can't be blank");
				}else{
					int contact=Integer.parseInt(c);
					int i=db.delete(contact);
					if(i>0){
						JOptionPane.showMessageDialog(deleteperson.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(deleteperson.this,"Unable to delete given id!");
					}
				}
			}
		});
